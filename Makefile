...
product: $@ ## Generate Pbs and build for product
...
clean: clean_product ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_product: ## Clean generated files for product
	${RM_F_CMD} product/${PROTO_DIR}/*.pb.go
